...
public class ESantePreferencePage extends FieldEditorPreferencePage implements
	...
	public ESantePreferencePage() {
		super(GRID);
		style = GRID;
		setPreferenceStore(Activator.getDefault().getPreferenceStore());
		setDescription("Evalon Sante Preferences");
	...
	protected Control createContents(Composite parent) {
		...
		Label label = new Label(this.fieldEditorParent, SWT.NONE);
		...
		Label databaseUserName1 = new Label(this.fieldEditorParent, SWT.NULL);
		databaseUserName1.setText("&DB Details");
